<?php
    ...
    $reqSelect = $bdd->query("SELECT * FROM staffteam");
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <table class="table table-danger table-striped">
                    ...
                    <tbody>
                        <?php while($staff = $reqSelect->fetch()) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="staff-edit.php?id=<?= $staff['id']; ?>" class="btn btn-primary btn-sm">Modifier</a>
                                <a href="staff-delete.php?id=<?= $staff['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('este-vous sure de vouloir supprimer cette catégorie ?');">Supprimer</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
