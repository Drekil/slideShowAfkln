        ...
        <header class="bg-afkln-bg2 py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-afkln-orange">
                    <h1 class="display-4 fw-bolder titre-header">Notre staff</h1>
                    ...
                    <div class="slider-wrapper">
                        ...
                        <div class="my-slider">
                            <?php 
                                ...
                                $stmt = $access->query('SELECT * FROM staffteam ORDER BY id ASC');
                                $i = 1;
                                foreach ($stmt as $row) : 
                            ?>
                            <div>
                                ...
                                ?>>
                                    <div>
                                        <a href="#">
                                            <img class="slide-img" src="../teams/uploads/<?= $row['staffPhoto'] ?>" alt=""/>
                                        </a>
                                    </div>
                                    <div>
                                        <a class="description" href="#">
                                            <h3><?= $row['name']." ".$row['surname'] ?></h3>
                                            <p><?= $row['staffPosition'] ?></p>
                                        </a>
                                    </div>
                                </div>
                                <?php
