    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5 formulaire">
                ...
                <form method="post" action="create-cible-player.php" enctype="multipart/form-data">
                <input type="hidden" name="id">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="int" class="form-control" id="jerseyNumber" name="jerseyNumber" aria-describedby="quantityStockHelp" required>
                        <div id="quantityStockHelp" class="form-text">*Champs obligatoire.</div>
                    </div>

                    <div class="mb-3">
                    <label for="sex" class="form-label">Sexe*</label>
                    <select class="form-control" id="sex" name="sex" aria-describedby="titreHelp" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="varchar" class="form-control" id="position" name="position" aria-describedby="sellingPriceHelp" required>
